...
void display(float ary[][3], int r)
{
    printf("\nyou just entered\n");
    for (int i = 0; i < r; i++)
    {
...
{
    int rows = 8;
    float ftable[8][3] = {5, 10, 5, 10, 15, 6, 15, 20, 15, 20, 25, 10, 25, 30, 5, 30, 35, 4, 35, 40, 2, 40, 45, 2};
    ...
    printf("\nmode from formula 1=%.2f", modval);
    modval = modef2(ftable, rows);
    printf("\nmode from formula 2=%.2f", modval);
}
